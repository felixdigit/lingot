...
{{/state.generator}}{{#state.decisions}}5. The decision surface: {{state.decisions}}.
{{/state.decisions}}
Then cross-check freshness: `git log --oneline -15` and the newest files on disk; reconcile any doc older than disk before acting.
